...
In this project we develop, analyze, evaluate and optimize a regression model to predict House prices in boston based on the UCI housing dataset

### Disclaimer

This is part the first project of [Udacity's](https://www.udacity.com/) Machine Learning Nanodegree. Some of the code in this project is already provided by the course organizers and is not written by me.
